...
// "hasAttr" Function
$.fn.h2ComAccHasAttr0016 = function (name) {
    var attr = $(this).attr(name);
    return (typeof attr !== typeof undefined && attr !== false);
};

// Focusable Items
function h2ComAccFocusable0016(focusElement) {
    return (focusElement.find('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'));
}

// Accordion Open/Close
function accordionTrigger0016(trigger, accordion) {
    ...
    if ($(trigger).parents(accordion).hasClass("h2-active")) {
        ...
        var focusableItems = h2ComAccFocusable0016(siblingContent);
...
$(document).ready(function () {
    $(document).on("click", "[data-h2-accordion-0-0-16] [data-h2-accordion-trigger]", function (e) {
        e.preventDefault();
        if ($(this).parents("[data-h2-accordion-0-0-16]").h2ComAccHasAttr0016("data-h2-no-js") == true) {
            // Do nothing.
        } else {
            var accordion = "[data-h2-accordion-0-0-16]";
            accordionTrigger0016(this, accordion);
        }
    });
});